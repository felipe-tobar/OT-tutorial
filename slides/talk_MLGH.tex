...
\begin{frame}{Kantorovich relaxation: \onslide<3>{mass splitting}}
...
\begin{frame}{OT between Gaussians}
\small 
If the measures have densities of the form
\begin{align*}
\centering
...
\begin{itemize}
    ...
    \item The OT cost (using the Euclidean ground cost) is: 
    \begin{equation}
...
\end{frame}
\begin{frame}{The one-dimensional case}
\small
...
\end{center}
We denote $F_{\mu}^{-}:[0,1]\to\R$ the generalized inverse of the cumulative distribution function (i.e. quantile function):
